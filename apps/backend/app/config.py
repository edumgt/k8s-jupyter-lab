...
class Settings(BaseSettings):
    ...
    backend_url: str = "http://192.168.253.149:30081/docs"
    frontend_url: str = "http://192.168.253.149:30080"
    control_plane_url: str = "http://192.168.253.149:30080/#control-plane"
    admin_url: str = "http://192.168.253.149:30080/#sandbox-admin"
    airflow_url: str = "http://192.168.253.149:30090"
    jupyter_url: str = "http://192.168.253.149:30088/lab"
    gitlab_url: str = "http://192.168.253.149:30089"
    nexus_url: str = "http://192.168.253.149:30091"
    pypi_index_url: str = "http://192.168.253.149:30091/repository/pypi-all/simple"
    npm_registry: str = "http://192.168.253.149:30091/repository/npm-all/"
    ...
    cors_allow_origins: str = (
        "http://192.168.253.149:30080,"
        "http://192.168.253.149:5173"
    )
